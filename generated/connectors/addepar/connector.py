...
# Partner : addepar
# Auth    : OAuth2AuthCodeStrategy
# Paging  : PageNumberPagination
# =============================================================================
...
class AddeparConnector(BaseConnector):
    """
    Generated connector for addepar.
    Base URL : https://{firm}.addepar.com
    Entities : transactions, positions, contacts, accounts
    """

    BASE_URL = "https://{firm}.addepar.com"

    def __init__(self, firm_id: str, credentials: Dict[str, Any]) -> None:
        auth = OAuth2AuthCodeStrategy(**credentials)
